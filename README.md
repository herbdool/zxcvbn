...
Zxcvbn-PHP is a password strength estimator using pattern matching and minimum entropy calculation. Zxcvbn-PHP is based on the the [Javascript zxcvbn](https://github.com/dropbox/zxcvbn) project from [Dropbox and @lowe](https://blogs.dropbox.com/tech/2012/04/zxcvbn-realistic-password-strength-estimation/). "zxcvbn" is a bad password, just like "qwerty" and "123456".
